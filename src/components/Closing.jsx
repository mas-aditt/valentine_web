      ...
      <div className="relative h-screen w-full overflow-hidden flex flex-col items-center justify-center">
        ...
        <div className='w-[90%] max-w-[400px]'>
          <p className="z-10 text-white text-center text-xl font-semibold px-4 drop-shadow-lg">
            Happy Valentine's Day Sayangkuu Cintakuu, aku nitip buket bunga ke dinda naila, semoga kamu suka yaa, aku sayang kamu, i loveeee uuuu sayanggg! -Mas Adit-
          </p>
        ...
        {/* Button */}
          <div className="flex justify-center w-full mt-12 z-10">
            ...
            >
              <ArrowLeft /> Sudah habis, klik untuk ke halaman sebelumnya
            </button>
          </div>   
        </div>
      </div>
